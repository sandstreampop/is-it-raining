// Runtime types generated with workerd@1.20241011.1 2024-10-11 nodejs_compat
/*! *****************************************************************************
...
declare var Request: {
	prototype: Request;
	new <CfHostMetadata = unknown, Cf = CfProperties<CfHostMetadata>>(input: RequestInfo<CfProperties>, init?: RequestInit<Cf>): Request<
		CfHostMetadata,
		Cf
	>;
};
...
declare module 'cloudflare:workers' {
	...
	export type WorkflowStep = {
		do:
			| (<T extends Rpc.Serializable>(name: string, callback: () => Promise<T>) => Promise<T>)
			| (<T extends Rpc.Serializable>(name: string, config: WorkflowStepConfig, callback: () => Promise<T>) => Promise<T>)
	...
	export abstract class WorkflowEntrypoint<Env = unknown, T extends Rpc.Serializable | unknown = unknown>
